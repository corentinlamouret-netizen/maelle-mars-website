-- Supabase PostgreSQL Schema for Maëlle Mars Website
...
CREATE INDEX idx_reservations_v2_email ON reservations_v2(email);
CREATE INDEX idx_reservations_v2_date ON reservations_v2(reservationDate);
CREATE INDEX idx_reservations_v2_status ON reservations_v2(paymentStatus);
...
CREATE INDEX idx_paypal_payments_transaction ON paypal_payments(paypalTransactionId);
CREATE INDEX idx_paypal_payments_reservation ON paypal_payments(reservationId);
